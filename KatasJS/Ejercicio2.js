...
let priceToys = toy1.price + toy2.price;
console.log(`La suma del precio de ambos juguetes es ${priceToys} .`)
...
console.log(`La el precio de car1 es de ${car1.finalPrice} .`)
car2.finalPrice = car2.basePrice + globalBasePrice;
console.log(`La el precio de car1 es de ${car2.finalPrice} .`)
